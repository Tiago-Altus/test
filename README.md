...
([https://github.com/guymontreuil/services-portal](https://github.com/guymontreuil/services-portal))
...
**Note:** As described above, the status code will always be 200, and the actualStatusCode property of the response body will contain the intended status code.
...
**Data Transfer &amp; Permissions App to Files in Client Access Portal S3 Bucket**
...
BY &#39;faiza abedin&#39;
ON &#39;2019-09-25T18:30:00&#39;
NOTE: &#39;why dont u copy paste&#39;]
...
Moves a file from SharePoint to S3 bucket and initialized the permissions for the Client Access Portal.
...
Success - HTTP 200
{
        ...
        &quot;contactsList&quot;: [
        {
                &quot;email&quot;: &quot;[Contact1@altusgroup.com](mailto:Contact1@altusgroup.com)&quot;,
                &quot;name&quot;: &quot;Contact1&quot;
        },
        {
                &quot;email&quot;: &quot;[Contact2@altusgroup.com](mailto:Contact2@altusgroup.com)&quot;,
                &quot;name&quot;: &quot;Contact2&quot;
        }
      ]
}
...
**Altus SharePoint API Endpoints**

([https://github.com/guymontreuil/altus-sharepoint-api](https://github.com/guymontreuil/altus-sharepoint-api))

**Create File from String**

Creates file in specified SharePoint folder with value of string.
This endpoint is used by estate master document generation program to create jsons in specific folders with flows that are triggered by them.
...
This endpoint is meant to help copy files from any local file system to a specified sharepoint file system. As a bonus this endpoint should work on a s3 bucket mounted file system to move items in an s3 bucket to sharepoint
...
NOTE: This section as of now, describes each model in the database.

| **Document\_contact** | **Document** | **Org\_business\_unit** | **Portal\_user** |
| --- | --- | --- | --- |
| Doc\_id: INT(11) | Doc\_id: INT(11) | Business\_unit\_id: STR(16) | Email\_address: STR(128) |
| Email\_address: STR(128) | File\_name: STR(250) | business\_unit\_name: STR(32) | Role\_id: STR(16) |
| email\_domain: STR(64) | file\_hash: STR(64) |   | is\_super\_admin: INT(1) |
| role\_id: STR(16) | file\_location: STR(250) |   | Is\_in\_print\_room: INT(1) |
| Language\_code: STR(8) | File\_size: INT(11) |   | Business\_unit\_id: STR(16) |
| print\_copy\_required: INT(1) | doc\_name: STR(512) |   | service\_line\_id: STR(32) |
| print\_copies: INT(6) | doc\_tags: STR(1024) |   | office\_id: STR(32) |
| contact\_name: STR(64) | report\_type: STR(16) |   | can\_send\_personal\_email: INT(4) |
| company\_name: STR(64) | report\_status\_id: STR(16) |   | select\_own\_projects\_only: INT(4) |
| company\_address: STR(256) | upload\_status: STR(16) |   | select\_own\_business\_unit\_only: INT(4) |
| delivery\_method: STR(64) | approval\_timestamp: DATE        |   | select\_own\_service\_line\_only: INT(4) |
| greeting\_name: STR(32) | upload\_timestamp: DATE |   | select\_own\_office\_only: INT(4) |
| preferred\_language: STR(8) | upload\_user: STR(128) |   |   |
|   | on\_hold: INT(1) |   |   |
|   | Reason\_for\_hold: STR(64) |   |   |
|   | Project\_id: STR(32) |   |   |
|   | Print\_instructions: STR(128) |   |   |
|   | Printing\_complete: INT(1) |   |   |
|   | Email\_custom\_message: STR(2000) |   |   |

| **Project\_Contact** | **Project** | **T\_and\_c\_versions** | **Terms\_and\_conditions** |
| --- | --- | --- | --- |
| project\_id: STR(32) | project\_id: STR(32) | application: STR(256) | application: STR(256) |
| email\_address: STR(128) | name: STR(64) | version: INT(11) | version: INT(11) |
| email\_domain: STR(64) | business\_unit\_id: STR(16) | filename: STR(256) | created\_at: DATE |
| role\_id: STR(16) | service\_line\_id: STR(32) |   |         updated\_at: DATE |
| print\_copy\_required: INT(1) | office\_id: STR(16) |   | html: TEXT(&#39;long&#39;) |
| print\_copies: INT(6) | confidential: BOOLEAN() |   |   |
| contact\_name: STR(64) | project\_principal\_email\_address: STR(128) |   |   |
| company\_name: STR(64) | project\_manager\_email\_address: STR(128) |   |   |
| company\_address: STR(256) |   |   |   |
| delivery\_method: STR(64)        |   |   |   |
| greeting\_name: STR(32)        |   |   |   |
| preferred\_language: STR(8) |   |   |   |
...
On the test and production servers, the private key is found at /etc/ssl/private/[test|prod]-selfsigned.key, and the certificate is found at /etc/ssl/certs/[test|prod]-selfsigned.crt, and the DH key is found at /etc/ssl/certs/[test|prod]-dhparam.crt.

In order for Node JS to be able to read the private key, which is by default in a directory owned by root, the following commands create a user group called &quot;certs&quot;, add the users bitnami and root to the group, and allow only group members to access the private key:
